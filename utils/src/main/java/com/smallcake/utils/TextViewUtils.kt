 ...
 */
@SuppressLint("UseCompatLoadingForDrawables")
fun TextView.drawLeft(icon:Int){
    val img: Drawable = this.resources.getDrawable(icon,null)
    img.setBounds(0, 0, img.minimumWidth, img.minimumHeight)
    this.setCompoundDrawables(img, null, null, null)
}
@SuppressLint("UseCompatLoadingForDrawables")
fun TextView.drawRight(icon:Int){
    val img: Drawable = this.resources.getDrawable(icon,null)
    img.setBounds(0, 0, img.minimumWidth, img.minimumHeight)
    this.setCompoundDrawables(null, null, img, null)
}
@SuppressLint("UseCompatLoadingForDrawables")
fun TextView.drawTop(icon:Int){
    val img: Drawable = this.resources.getDrawable(icon,null)
    img.setBounds(0, 0, img.minimumWidth, img.minimumHeight)
    this.setCompoundDrawables(null, img, null, null)
}
@SuppressLint("UseCompatLoadingForDrawables")
fun TextView.drawBottom(icon:Int){
    val img: Drawable = this.resources.getDrawable(icon,null)
    img.setBounds(0, 0, img.minimumWidth, img.minimumHeight)
    this.setCompoundDrawables(null, null, null, img)
}